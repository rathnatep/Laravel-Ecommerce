...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        // Built-in fonts live here; custom fonts are loaded via @font-face in the invoice CSS.
         ...
         */
        'chroot' => realpath(base_path()),  // fonts in resources/ are inside base_path()
         ...
         * @var bool
         */
        'enable_remote' => false,  // local fonts only; no remote asset fetching needed
